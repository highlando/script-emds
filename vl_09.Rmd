# Stochastistic Gradient and Learning
...
```{py name='Stochastistisches Gradientenabstiegsverfahren'}
###################################################
...
Da die einzelnen Gradienten $\nabla Q_j(w^K)$ unabh&auml;ngig voneinander berechnet werden k&ouml;nnen, kann so ein *batch* Verfahren effizient auf Computern mit mehreren Prozessoren realisiert werden. Die Konvergenztheorie ist nicht wesentlich verschieden vom eigentlichen *stochastistischen Gradientenabstiegsverfahren*, allerdings erscheint die beobachte Konvergenz weniger erratisch, da der Mittelwert statistische Ausrei&szlig;er ausmitteln kann.
 ...
 * eine Funktion, die den stochastistischen Gradienten &uuml;ber einem kleinen *batch* von Daten ausrechnet
