...
\hypertarget{numerische-berechnung-des-gradienten}{%
\subsection{Numerische Berechnung des Gradienten}\label{numerische-berechnung-des-gradienten}}
...
\hypertarget{optimierung-ohne-gradienten-p}{%
\subsection{Optimierung ohne Gradienten (P)}\label{optimierung-ohne-gradienten-p}}
...
Überlegen Sie sich eine mögliche Verbesserung dieses rein auf Zufall basierenden Verfahrens.
