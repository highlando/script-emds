...
\hypertarget{iris-datensatz-targets-plotten-p}{%
\subsection{Iris Datensatz -- Targets Plotten (P)}\label{iris-datensatz-targets-plotten-p}}
...
\hypertarget{iris-datensatz-2d-plots-p}{%
\subsection{Iris Datensatz -- 2D plots (P)}\label{iris-datensatz-2d-plots-p}}
...
Berechnen sie Hauptachsen und stellen Sie die Daten in den Hauptachsenkoordinaten dar (wie in Abbildung \ref{fig:05-iris-allpairs-pcs}).
