...
\begin{theorem}
Sei \(D(f) \subseteq \mathbb{R}^{n}\) offen, und sei \(f: D(f) \rightarrow \mathbb{R}\) partiell differenzierbar. Besitzt \(f\) in \(\mathbf{x}^{*} \in D(f)\) ein lokales Extremum, dann ist \(\nabla f(\mathbf{x}^{*})=0\).
\end{theorem}

Liegt in \(x^*\) ein Extremum vor und \(x^*\) liegt nicht auf dem Rand, so verschwindet die erste Ableitung.

Definition 17.30 (Hesse \({ }^{40}\)-Matrix). Sei \(D \subseteq \mathbb{R}^{n}\) offen, und sei \(f: D \rightarrow \mathbb{R}\) eine 2 -mal stetig partiell differenzierbare Funktion. Für \(\mathbf{x}^{\star} \in D\) heißt die symmetrische \((n \times n)\)-Matrix
\[
...
Satz 17.31 ((vgl. Satz 13.18 ii), iii) und Satz 9.37)). Sei \(D \subset \mathbb{R}^{n}\) offen, und sei \(f: D \rightarrow \mathbb{R}\) eine 2-mal stetig partiell differenzierbare Funktion. Sei \(\mathbf{x}^{\star} \in D \operatorname{mit} \operatorname{grad} f\left(\mathbf{x}^{\star}\right)=\mathbf{0}\).
40 Otto Hesse, 1811-1874
94
i) Ist \(H_{f}\left(\mathbf{x}^{\star}\right)\) positiv definit, dann ist \(\mathbf{x}^{\star}\) ein lokales Minimum.
ii) Ist \(H_{f}\left(\mathbf{x}^{\star}\right)\) negativ definit, dann ist \(\mathbf{x}^{\star}\) ein lokales Maximum.
iii) Ist \(H_{f}\left(\mathbf{x}^{\star}\right)\) weder positiv noch negativ semi-definit (d.h. indefinit), dann ist \(\mathbf{x}^{\star}\) kein lokales Extremum, sondern ein Sattelpunkt.
iv) Ist \(H_{f}\left(\mathbf{x}^{\star}\right)\) negativ semi-definit oder positiv-definit, dann ist keine Aussage möglich.
