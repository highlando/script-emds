...
### Truncated SVD (P+T)
 ...
 1. **(P+T)** F&uuml;r die "echten" Daten: Speichern sie die Faktoren der bei $\hat r$ abgeschnittenen SVD und vergleichen Sie den Speicherbedarf der Faktoren und der eigentlichen Matrix.
